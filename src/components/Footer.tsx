    ...
    <footer className="border-t border-border/40 mt-8 relative z-10">
      <div className="max-w-[1200px] mx-auto px-4 py-6">
        <div className="flex flex-col items-center justify-center gap-4 md:flex-row md:justify-between">
          ...
          <div className="flex items-center justify-start gap-4 md:gap-6 order-1 md:order-2 md:justify-end">
            <a 
              href="https://docs.dork.fi" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="inline-flex h-8 items-center gap-2 text-ocean-teal hover:text-ocean-teal/80 transition-colors text-sm font-medium leading-none"
            >
              Documentation <ExternalLink size={14} />
            </a>
            <a 
              href="https://discord.gg/dorkfi" 
              target="_blank" 
              rel="noopener noreferrer" 
