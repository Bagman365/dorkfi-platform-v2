    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      {metrics.map((metric, index) => {
        ...
        return (
          <Card 
            key={metric.title}
            className={`${metric.color} border-2 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:${metric.glowColor} animate-fade-in`}
