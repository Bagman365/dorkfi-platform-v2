...
const DepositModal = ({ isOpen, onClose, tokenSymbol, tokenIcon, userBalance, marketStats }: DepositModalProps) => {
            ...
            <>
              <DialogHeader className="pt-6 px-8 pb-1">
                ...
                <DialogDescription className="text-center mt-1 text-sm text-slate-400 dark:text-slate-400">
                  Enter the amount to deposit. Your available balance and rates are shown below.
                </DialogDescription>
